  ...
  return (
    <div>
        <div className='nav-wrapper d-flex justify-content-between ps-4 pe-3 align-items-center'>
            ...
            <div className='imdb-tittle me-1'>IMDb</div>
        <Link to={"/"} ><button className='btn button-hover text-white'><IoMdHome style={{cursor:"pointer"}} color='white' size={ 25}/></button></Link>
